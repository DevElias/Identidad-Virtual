...
class Region extends BaseModel
{
    ...
    public function select()
    {
        ...
        $sql .= "SELECT ";
        $sql .= "id     as 'ID_Region', ";
        $sql .= "nombre as 'Nombre_Region', ";
        $sql .= "codigo as 'Codigo_Region', ";
        $sql .= "status as 'Status_Region', ";
    ...
    public function GuardarRegion($aParam)
    {
        $sql  = "";
    ...
    public function ActualizarRegion($aParam)
    {
        $sql  = "";
