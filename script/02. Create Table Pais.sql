...
CREATE TABLE pais (
   ...
   nombre VARCHAR(100) NOT NULL COLLATE utf8_general_ci COMMENT 'Nombre del Pais',
   codigo VARCHAR(100) NOT NULL COLLATE utf8_general_ci COMMENT 'Codigo del Pais',
  ...
  PRIMARY KEY (id)
) ENGINE=INNODB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Tabla de Pais';